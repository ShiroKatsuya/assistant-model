...
from jarvis_ui import draw_complete_animation
...
def pause_audio_processing():
    ...
    jarvis_ui.update_status("Pause for sound...")
...
def resume_audio_processing():
    ...
    jarvis_ui.update_status("Resume for sound...")
    ...
    try:
        while True:
            ...
            if detect_sound(data):
                jarvis_ui.update_status("Mendeteksi suara, mulai merekam...")
                if status_label:
                ...
                if random_file:
                    ...
                    jarvis_ui.update_status("No intro file found to play...")
