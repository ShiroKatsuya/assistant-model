...
import numpy as np
# from neural import compute_ann, compute_custom_ann
import colorsys
...
def compute(method, color, fig, wf):
  ...
  # elif method == 'neural':
  #   return compute_ann(fig, wf, color)
  # elif method == 'neural_deep':
  #   # Deep neural network with more layers
  #   return compute_custom_ann(fig, wf, color, [16, 12, 10, 8, 6, 4], particle_density=3)
  # elif method == 'neural_wide':
  #   # Wide neural network
  #   return compute_custom_ann(fig, wf, color, [24, 16, 8], particle_density=4)
  # elif method == 'neural_custom':
  #   return compute_custom_ann(fig, wf, color, [12, 10, 8, 6, 4], particle_density=2)
  # else:
  #   print('Unknown method. Try one of the following:')
  #   print('"bars"', '"spectrum"', '"wave"', '"rain"', '"neural"', '"neural_deep"', '"neural_wide"', '"neural_custom"')
    # return None