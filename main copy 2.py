                ...
                try:
                    ...
                    with visualization_lock:
                        ...
                        try:
                            ...
                            # Timeout of 60 seconds to wait for visualization to complete (increased from 45)
                            if not visualization_complete_event.wait(timeout=60):
                                print("Visualization timed out, proceeding with next task")
